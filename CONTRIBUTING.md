...
Welcome to [Musepipe](https://github.com/onuralpszr/Musepipe)! Before sending your pull requests, make sure that you __read the whole guidelines__. If you have any doubt on the contributing guide, please feel free to [state it clearly in an issue](https://github.com/onuralpszr/Musepipe/issues/new)
